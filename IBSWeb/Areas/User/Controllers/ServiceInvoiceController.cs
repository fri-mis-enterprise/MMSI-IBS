    ...
    public class ServiceInvoiceController : Controller
    {
        ...
        public async Task<IActionResult> Void(int id, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _unitOfWork.ServiceInvoice.RemoveRecords<SalesBook>(gl => gl.SerialNo == model.ServiceInvoiceNo, cancellationToken);
                await _unitOfWork.ServiceInvoice.RemoveRecords<GeneralLedgerBook>(gl => gl.Reference == model.ServiceInvoiceNo, cancellationToken);
        ...
        public async Task<IActionResult> Edit(ServiceInvoiceViewModel viewModel, CancellationToken cancellationToken)
        {
            ...
            viewModel.Customers = await _unitOfWork.GetCustomerListAsyncById(existingModel.Company, cancellationToken);
            viewModel.Services = await _unitOfWork.GetServiceListById(existingModel.Company, cancellationToken);
        ...
        public async Task<IActionResult> GetDRsByCustomer(int customerId, int previousSelectedDr)
        {
            ...
            foreach (var dr in drs)
            {
                ...
                var cost = await _unitOfWork.PurchaseOrder.GetPurchaseOrderCost((int)dr.PurchaseOrderId!);
        ...
        {
            var relatedRrNo = (await _unitOfWork.ReceivingReport
