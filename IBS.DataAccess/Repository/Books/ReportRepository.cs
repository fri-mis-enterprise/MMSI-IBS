...
namespace IBS.DataAccess.Repository.Books
{
    public class ReportRepository : Repository<GeneralLedgerBook>, IReportRepository
    {
        ...
        public async Task<List<SalesInvoice>> GetSalesInvoiceReport(DateOnly dateFrom, DateOnly dateTo, string company,
        ...
        public async Task<List<ServiceInvoice>> GetServiceInvoiceReport(DateOnly dateFrom, DateOnly dateTo, string company, CancellationToken cancellationToken = default)
        {
            if (dateFrom > dateTo)
            {
                throw new ArgumentException("Date From must not be greater than Date To!");
            ...
            // Fetch all delivery receipts within the date range
            var serviceInvoices = await _db.ServiceInvoices
                .Where(dr => dr.Company == company &&
                             dr.Period >= dateFrom &&
                             dr.Period  <= dateTo &&
        ...
        public async Task<List<PurchaseOrder>> GetPurchaseOrderReport(DateOnly dateFrom, DateOnly dateTo, string company, CancellationToken cancellationToken = default)
        {
            if (dateFrom > dateTo)
            {
                throw new ArgumentException("Date From must not be greater than Date To!");
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var additionalDeliveryReceiptsQuery = _db.DeliveryReceipts
        ...
        public async Task<List<CollectionReceipt>> GetCollectionReceiptReport(DateOnly dateFrom, DateOnly dateTo, string company, CancellationToken cancellationToken = default)
        {
            if (dateFrom > dateTo)
            {
                throw new ArgumentException("Date From must not be greater than Date To!");
            ...
            var collectionReceipts = await _db.CollectionReceipts
        ...
        public async Task<List<SalesInvoice>> GetARPerCustomerReport(DateOnly dateFrom, DateOnly dateTo, string company, List<int>? customerIds = null, CancellationToken cancellationToken = default)
        {
            if (dateFrom > dateTo)
            {
                throw new ArgumentException("Date From must not be greater than Date To!");
            ...
            DateOnly dateTo, string company, CancellationToken cancellationToken = default)
        {
            ...
            // Base query without date filter yet
            var journalVoucherDetails = await _db.JournalVoucherDetails
