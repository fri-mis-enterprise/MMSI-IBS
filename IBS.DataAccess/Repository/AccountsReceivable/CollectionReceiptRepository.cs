...
namespace IBS.DataAccess.Repository.AccountsReceivable
{
    public class CollectionReceiptRepository : Repository<CollectionReceipt>, ICollectionReceiptRepository
    {
        ...
        public async Task PostAsync(CollectionReceipt collectionReceipt, List<Offsettings> offsettings, CancellationToken cancellationToken = default)
        {
